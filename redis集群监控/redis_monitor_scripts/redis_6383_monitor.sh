...
dir_name=$(dirname $0)
cnf_file=$dir_name/redis_6383_conf.sh
...
log_file=/var/log/monitor_redis_6383.log
...
monitor_redis() {
    case $1 in
        connected_clients|used_memory|role)
            ...
            /usr/local/zabbix/bin/zabbix_sender -z $zabbix_server -s $host -k redis_6383.$1 -o $val
            ;;
        *)
